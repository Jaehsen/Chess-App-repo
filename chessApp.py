...
def boardWithLabels(board: chess.Board, flipped: bool) -> str: 
    """returns a string representing chess board with rows and columns labeled and can optionally be flipped to show the black player's view of the board"""
...
def boardToLegalMoveListUCI(board: chess.Board) -> list: 
    """Turns LegalMoveGenerator returned by board.legal_moves into a list of legal moves using uci notation Ex: Legal Moves: ['g1h3', 'g1f3', 'b1c3', 'b1a3', 'h2h3', 'g2g3', 'f2f3', 'e2e3', 'd2d3', 'c2c3', 'b2b3', 'a2a3', 'h2h4', 'g2g4', 'f2f4', 'e2e4', 'd2d4', 'c2c4', 'b2b4', 'a2a4']"""
